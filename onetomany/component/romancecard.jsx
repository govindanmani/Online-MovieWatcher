...
function Romancecard() {
  ...
  const fetchData = async () => {
    try {
      // const response = await axios.get(`http://localhost:3001/comments/${idvalue}`);
      const response = await axios.get(`/Romance/${idvalue}`);
      ...
      <div className="hole">
         ...
         <div className="box" style={{marginTop:"40px",marginLeft:"200px"}}>
          <div key={dataItem.id} className="topic">
            ...
            <img src={dataItem.img} className="img" style={{width:"240px"}}></img>
