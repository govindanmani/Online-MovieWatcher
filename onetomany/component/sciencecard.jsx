...
function Sciencscard() {
  ...
  const fetchData = async () => {
    try {
      // const response = await axios.get(`http://localhost:3001/science/${idvalue}`);
      const response = await axios.get(`/Scientific/${idvalue}`);
