...
function Actioncard() {
  ...
  const fetchData = async () => {
    try {
      // const response = await axios.get(`http://localhost:3001/posts/${idvalue}`);
      const response = await axios.get(`/action/${idvalue}`);
      ...
      <div className="hole">
         ...
         <div className="box" style={{marginTop:"40px",marginLeft:"200px"}}>
          <div key={dataItem.id} className="topic">
            ...
            <img src={dataItem.img} className="img" style={{width:"400px"}}></img>
