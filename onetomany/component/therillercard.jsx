...
function Therillercard() {
  ...
  const fetchData = async () => {
    try {
      // const response = await axios.get(`http://localhost:3001/theriller/${idvalue}`);
      const response = await axios.get(`/Thriller/${idvalue}`);
